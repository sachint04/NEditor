define([
	 ...
	 */
	function pg07(p_oCourseController, p_$pageHolder, p_domView, p_xmlData, p_cssData, p_sGUID){
		//Logger.logDebug('pg07.CONSTRUCTOR() ');
	...
	pg07.prototype									= Object.create(PageAbstract.prototype);
	pg07.prototype.constructor						= pg07;
	 ...
	 */
	pg07.prototype.initialize						= function(){
		var oScope				= this,
	...
	pg07.prototype.handleEvents 					= function(e){
		//Logger.logDebug('pg07.handleButtonEvents() '+$(e.target).attr('id'));
		e.preventDefault();
		var sBtnName	= e.target.getAttribute('id'),
			sBtnText	= $(e.target).html();
		sPopupText			= Globals.getElementByID(this.$domView, e.target.getAttribute('target'), 'pg07.initialize()').html();
	 ...
	 */
	pg07.prototype.destroy 							= function(){
		//Logger.logDebug('pg07.destroy() | ');
		// ** START - Custom Implementation for destroying Page variables
		var oScope			= this,
			$helpfulTipsBtn		= Globals.getElementByID(this.$domView, 'btn_helpfultips', 'pg07.initialize()');
