define([
	 ...
	 */
	function TabHorizontal(p_oCourseController, p_$pageHolder, p_domView, p_xmlData, p_cssData, p_sGUID){
		//Logger.logDebug('TabHorizontal.CONSTRUCTOR() ');
	...
	TabHorizontal.prototype									= Object.create(PageAbstract.prototype);
	TabHorizontal.prototype.constructor						= TabHorizontal;
	 ...
	 */
	TabHorizontal.prototype.initialize						= function(){
	    //Logger.logDebug('TabHorizontal.initialize() ');
	 ...
	 */
	TabHorizontal.prototype.destroy 							= function(){
	    //Logger.logDebug('TabHorizontal.destroy() ');
