define([
	...
	pg09.prototype.handleEvents 					= function(e){
		//Logger.logDebug('pg09.handleButtonEvents() '+$(e.target).attr('id'));
		e.preventDefault();
		var sBtnName	= e.target.getAttribute('id'),
			sBtnText	= $(e.target).html();
		sPopupText			= Globals.getElementByID(this.$domView, e.target.getAttribute('target'), 'pg09.initialize()').html();
	...
	pg09.prototype.destroy 							= function(){
		...
		var oScope			= this,
			$helpfulTipsBtn		= Globals.getElementByID(this.$domView, 'btn_helpfultips', 'pg09.initialize()');
