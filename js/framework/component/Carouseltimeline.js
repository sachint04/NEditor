define([
	...
	Carousel.prototype.init									= function(p_sID, p_oConfig) {
		//Logger.logDebug('Carousel.init() | Comp ID = '+p_sID);
		this.oAnimateProps	= {
			open	: {},
			close	: {}
		};
	...
	Carousel.prototype.createComponent						= function() {
		//Logger.logDebug('Carousel.createComponent() | ');
		...
		// Previous Button.
		var $paginationContainer			= this.$component.find('.' + this.getConfig().paginationContainerClass).append('<span class="pagination"></span>');
