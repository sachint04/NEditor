define([
	...
	function MMCQGroupModel(p_xmlActivityNode,  p_sGUID, p_sScoringUID){
		//Logger.logDebug('MMCQGroupModel.CONSTRUCTOR() ');
		ComponentModelAbstract.call(this, p_xmlActivityNode,  p_sGUID, p_sScoringUID);
	}

	MMCQGroupModel.prototype										= Object.create(ComponentModelAbstract.prototype);
	MMCQGroupModel.prototype.constructor							= MMCQGroupModel;

	MMCQGroupModel.prototype.getOptionGroupsContainerClass		= function(){return this.oDataModel.optionGroups._class;};
	MMCQGroupModel.prototype.getOptionGroupList					= function(){return this.oDataModel.optionGroups.optionGroup;};
	MMCQGroupModel.prototype.getFeedbackType						= function(){return this.oDataModel._fbType;};

	MMCQGroupModel.prototype.getBookmark							= function(){
	...
	MMCQGroupModel.prototype.parseBookmark						= function(p_oBookmark){
		if(this.oDataModel){
			/*
		...
		Logger.logError('MMCQGroupModel.setBookmark() | Failed to set Bookmark. The Data Model does not exists.');
	};



	MMCQGroupModel.prototype.getHistory						= function(p_aIDs){
	...
	MMCQGroupModel.prototype.getOptionalData				= function(p_oOptionalData){
		// START 
	...
	MMCQGroupModel.prototype.toString 						= function(){
			return 'framework/activity/model/MMCQGroupModel';
		};

	return MMCQGroupModel;
});